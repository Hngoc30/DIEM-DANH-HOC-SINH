...
const char* ssid = "Zone Six 10NTP";  //--> Your wifi name
const char* password = "10nguyentriphuong";
// Google script Web_App_URL.
String Web_App_URL = "https://script.google.com/macros/s/AKfycbxEhows_Bsc_0XPG3H67VFOZ7Y8eecQeTk5nMBq1ulaMMc_d_seyC8bYZGMsSu-dIrM/exec";
